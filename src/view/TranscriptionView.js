    ...
    return (
      <div className={transcriptionClass} style={style}>
        ...
        <div className="part-4">
          Il se faict coe le ciment qui est<br/>
        ...
        <div className="part-5">
          ...
          une once de vermeillon broye subtillem avecq huile de noix<br/>
          ...
          peur que le feu ne sy prenne Apres trempe en tournoyat<br/>
