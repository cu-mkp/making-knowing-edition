            ...
            return (
                  <div id="entry-list-view">
                        <div className="header">
                              ...
                              <Typography>Ms. Fr. 640 consists almost entirely of units of text under titles, which the Project has called “entries.” The List of Entries forms an index to browse the manuscript.</Typography><br />
