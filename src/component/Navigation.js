			...
			return (
				<div className={thisClass} style={thisStyle}>
						...
						<div className="breadcrumbs" style={thisStyle}>
							<span title="Lock/Unlock" onClick={this.toggleLockmode} className={(this.props.navigationState.inSearchMode)?'invisible':lockIconClass}></span>
							&nbsp;
							<span title="Toggle book mode" onClick={this.toggleBookmode} className={(this.props.navigationState.inSearchMode)?'invisible':bookIconClass}></span>
							&nbsp;
							<span title="Toggle XML mode" onClick={this.toggleXMLMode} className={(this.props.navigationState.inSearchMode || imageViewActive )?'invisible':xmlIconClass}></span>
							&nbsp;
							<span title="Toggle single column mode"  onClick={this.toggleColumns} className={(this.props.navigationState.inSearchMode)?'invisible':columnIconClass}></span>
							&nbsp;
							<span 	title = "Go back"
