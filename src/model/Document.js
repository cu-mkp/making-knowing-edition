  ...
  constructor() {
    ...
    this.folios = [
      ...
      new Folio( {
        id: `folio${i++}`,
        name: '6v',
        image_zoom_url: 'http://gallica.bnf.fr/iiif/ark:/12148/btv1b10500001g/f18/info.json',
      ...
      new Folio( {
        id: `folio${i++}`,
        name: '10r',
        image_zoom_url: 'http://gallica.bnf.fr/iiif/ark:/12148/btv1b10500001g/f25/info.json',
      ...
      new Folio( {
        id: `folio${i++}`,
        name: '16r',
        image_zoom_url: 'http://gallica.bnf.fr/iiif/ark:/12148/btv1b10500001g/f37/info.json',
      ...
      new Folio( {
        id: `folio${i++}`,
        name: '46v',
        image_zoom_url: 'http://gallica.bnf.fr/iiif/ark:/12148/btv1b10500001g/f98/info.json',
      ...
      new Folio( {
        id: `folio${i++}`,
        name: '75r',
        image_zoom_url: 'http://gallica.bnf.fr/iiif/ark:/12148/btv1b10500001g/f155/info.json',
      ...
      new Folio( {
        id: `folio${i++}`,
        name: '101r',
        image_zoom_url: 'http://gallica.bnf.fr/iiif/ark:/12148/btv1b10500001g/f207/info.json',
